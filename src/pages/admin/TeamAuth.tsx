  ...
  return (
    <div className="mx-auto max-w-md px-4 py-12">
      ...
      <div className="card animate-pop-in">
        {/* Google — the recommended path (no password to manage) */}
        <button
          type="button"
          onClick={handleGoogle}
          disabled={busy}
          className="flex w-full items-center justify-center gap-3 rounded-xl border-2 border-slate-200 bg-white px-4 py-2.5 font-display font-semibold text-slate-700 transition hover:bg-slate-50 focus:outline-none focus-visible:ring-2 focus-visible:ring-bff-400 focus-visible:ring-offset-2 disabled:opacity-50"
        >
