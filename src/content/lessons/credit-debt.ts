  ...
  zh: {
    ...
    sections: [
      ...
      },
      {
        ...
        body:
          '你刚刚学了这五大因素——现在来看Two Cents拆解它们在现实生活中是如何体现的。视频是英文的，中途会暂停来检验你记住了多少，所以注意力集中！',
        videoId: 'ozbGWLtZdoY',
        source: 'Two Cents · PBS Digital Studios',
        questions: [
          {
            at: 110,
            question: '在你的FICO信用分数里，哪个因素占的比重最大？',
            options: [
              '你拥有多少张信用卡',
              '你的还款记录——按时付账单',
              '你的工资',
            ...
            answerIndex: 1,
            explanation:
              '还款记录是重量级选手，占你分数的35%。哪怕只错过一次付款，也可能困扰你的分数好几年——这就是为什么自动扣款是你最好的朋友。',
          },
          {
            at: 240,
            question: '根据视频，你能对信用分数做的最糟糕的事情之一是什么？',
            options: [
              '保留一张旧信用卡不注销',
              '使用不到30%的信用额度',
              '错过一次付款',
            ...
            answerIndex: 2,
            explanation:
              '错过一次付款会重创最大的因素（35%！），而且会在你的报告上留存长达七年。旧账户和低使用率其实是在帮你，查看自己的报告也永远不会伤害你的分数。',
          },
        ],
      },
      {
