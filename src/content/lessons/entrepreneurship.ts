  ...
  zh: {
    ...
    sections: [
      ...
      },
      {
        ...
        heading: '再投资：喂养这台机器',
        body:
          '这里有一个把小打小闹的人和帝国缔造者区分开来的习惯：再投资。别把每一美元利润都花掉，而是留出一部分——比如说25-30%——用来让生意变得更好。Darius从每周209美元的利润里存下60美元；一个月他就有了240美元，够买一台二手吹叶机，让他能在每片草坪上多收15美元的清理附加服务费。利润买来工具，工具抬高收入，收入做大利润。这个循环就是小副业如何滚成雪球的。☃️',
        bullets: [
