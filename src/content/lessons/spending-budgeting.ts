  ...
  zh: {
    ...
    sections: [
      ...
      },
      {
        ...
        heading: '观看：预算入门',
        body:
          '在聊记录之前，先看这段来自 Two Cents 的短视频。视频是英文的，注意——它会中途暂停来考你，所以要专心！（有趣的是：它是从 George Washington 讲起的。对，真的。）',
        videoId: 'sVKQn2I4HDM',
        source: 'Two Cents · PBS Digital Studios',
        questions: [
          {
            at: 95,
            question:
              '主持人把做预算比作 George Washington 率领大陆军。这个比喻想说明什么？',
            options: [
              'Washington 发明了第一份预算电子表格',
              '就像 Washington 一样，你必须用有限的资源做出聪明的计划',
              '预算只有在战争时期才重要',
              '你应该像军队消耗补给一样飞快地花钱',
            ],
            answerIndex: 1,
            explanation:
              'Washington 几乎从来没有足够的士兵或补给——所以他必须用手头有的东西去谋划。预算正是如此：一份为有限的钱制定的作战计划。',
          },
          {
            at: 250,
            question: '根据视频，建立预算的第一步是什么？',
            options: [
              '办一张信用卡',
              '在脑子里猜你的支出',
              '把它写下来——写在纸上、电子表格里或 App 里',
              '等到你赚更多钱再说',
            ],
            answerIndex: 2,
            explanation:
              '第一步是把你的计划写下来——铅笔加纸、电子表格或 App 都行。然后每个月更新它，因为预算是一份活的计划，而不是一次性的愿望。',
          },
        ],
      },
      {
