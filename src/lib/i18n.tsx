...
const STRINGS: Record<string, { en: string; es: string }> = {
  ...
  'lesson.startQuiz': { en: 'Start the quiz', es: 'Empezar el examen' },
  'lesson.seeResults': { en: 'See my results', es: 'Ver mis resultados' },
  'lesson.step': { en: 'Step', es: 'Paso' },
  'lesson.of': { en: 'of', es: 'de' },
  'lesson.questionWord': { en: 'Question', es: 'Pregunta' },
  'lesson.complete': { en: 'Complete!', es: '¡Completado!' },
  'lesson.reviewAnswers': { en: 'Review your answers', es: 'Revisa tus respuestas' },
  'lesson.retake': { en: 'Retake quiz', es: 'Repetir examen' },
  'lesson.backToLessons': { en: 'Back to lessons', es: 'Volver a lecciones' },
  'lesson.nextLesson': { en: 'Next lesson', es: 'Próxima lección' },
  'lesson.yourAnswer': { en: 'Your answer:', es: 'Tu respuesta:' },
  'lesson.correctAnswer': { en: 'Correct answer:', es: 'Respuesta correcta:' },
  'lesson.correctChip': { en: 'Correct', es: 'Correcta' },
  'lesson.missedChip': { en: 'Missed', es: 'Fallada' },
  'lesson.enterTip': { en: 'Tip: press', es: 'Consejo: presiona' },
  'lesson.enterTipEnd': { en: 'to continue', es: 'para continuar' },
  'lesson.quizKicker': { en: 'Quiz', es: 'Examen' },
  'readAloud.play': { en: 'Read this step aloud', es: 'Leer este paso en voz alta' },
  'readAloud.stop': { en: 'Stop reading', es: 'Detener lectura' },
}
